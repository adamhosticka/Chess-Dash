...
def fetch_data(fetch_all_and_reformat: bool, fetch_all_and_reformat_short: bool, fetch_countries: bool,
               fetch_country_players: bool, hundreds_of_players: int, hundreds_of_games: int,
               reformat_and_save: bool, disable_print_info: bool):
    ...
    :param: bool disable_print_info: Disable print info switch.
    """
    print_info = not disable_print_info
    ...
    if fetch_all_and_reformat_short:
        fetch_countries = True
        fetch_country_players = True
        hundreds_of_players = 2
        hundreds_of_games = 1
        reformat_and_save = True
...
if __name__ == '__main__':
    ...
    parser.add_argument("-fars", "--fetch-all-and-reformat-short",
                        default=False,
                        action='store_true',
                        help="Fetch countries, players (200) and games (100) - then reformat them. "
